...
const items = [
  { href: "/dashboard" as Route, key: "nav.dashboard", icon: "M3 10.5 12 3l9 7.5V21a1 1 0 0 1-1 1h-5v-7H9v7H4a1 1 0 0 1-1-1v-10.5z" },
  { href: "/quotes" as Route, key: "nav.quotes", icon: "M7 3h7l5 5v13a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm7 0v5h5" },
  { href: "/quotes/new" as Route, key: "common.new", icon: "M12 5v14M5 12h14", cta: true },
  { href: "/works" as Route, key: "nav.works", icon: "M4 7h16M4 12h16M4 17h10" },
  { href: "/clients" as Route, key: "nav.clients", icon: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" },
  { href: "/catalog" as Route, key: "nav.catalog", icon: "M4 6h16M4 12h16M4 18h16" },
];
